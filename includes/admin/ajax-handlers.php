...
class Disco747_AJAX_Handlers {
    ...
    /**
     * ✅ Handler principale per batch scan - OTTIMIZZATO con offset/batch_size
     */
    public static function handle_batch_scan() {
        ...
        // ✅ PARAMETRI con offset e batch_size
        ...
        try {
            // ✅ Usa GoogleDrive_Sync per elaborazione ottimizzata
            ...
            // ✅ CHIAMA il metodo ottimizzato con offset e batch_size
            $result = $gdrive_sync->scan_excel_files_batch($offset, $batch_size);
            ...
            // ✅ RISPOSTA OTTIMIZZATA con info batch
            wp_send_json_success(array(
                'complete' => !$result['has_more'], // true se è l'ultimo batch
